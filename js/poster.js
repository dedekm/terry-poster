...
(function() {
  var Grid, HEIGHT, MATERIAL, Tube, WIDTH, appendChild, camera, canvas, ctx, getData, grid, j, pixelGrid, render, renderer, scene, tube,
  ...
  Tube = (function() {
    ...
    Tube.prototype.possible_directions = function() {
      var direction, directions, j, len, preferable, results;
      ...
      directions = [!grid.getNode(this.x + 1, this.y, this.z) ? 'right' : void 0, !grid.getNode(this.x, this.y + 1, this.z) ? 'up' : void 0, !grid.getNode(this.x, this.y, this.z + 1) ? 'forward' : void 0, !grid.getNode(this.x - 1, this.y, this.z) ? 'left' : void 0, !grid.getNode(this.x, this.y - 1, this.z) ? 'down' : void 0, !grid.getNode(this.x, this.y, this.z - 1) ? 'backward' : void 0].filter(Boolean);
      results = [];
