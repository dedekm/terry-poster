...
(function() {
  ...
  window.init = function() {
    ...
    scene.add(mesh);
    renderPDF = function() {
      var dataURL, doc, len3, len4, q, r, ref2, string;
      ...
      s = ['The Matrix – The Wachowskis', '© Martin Dedek, Graficky design 2, FUD UJEP', '', 'poster generated by software licensed under the MIT licence', 'dedekm.github.io/terry-poster', new Date().toUTCString() + ' for Terry posters'];
      ...
      doc.save('Test.pdf');
      return doc.output('dataurlstring', 'Test.pdf');
    };
    render = function() {
