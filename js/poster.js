...
(function() {
  ...
  window.init = function() {
    ...
    scene.add(mesh);
    renderPDF = function() {
      var align, dataURL, doc, len3, q, ref2;
      ...
      doc.text(s, 12 + align, 975);
      s = '© Martin Dedek, Graficky design 2, FUD UJEP';
      doc.text(s, 12 + align, 980);
      s = new Date().toUTCString() + ' for Terry posters';
      doc.text(s, 12 + align, 985);
      s = 'poster generated by software licensed under the MIT licence';
      doc.text(s, 12 + align, 995);
      s = 'dedekm.github.io/terry-poster';
      doc.text(s, 12 + align, 1000);
      ref2 = [
        {
          c: 255,
          w: 1.5
